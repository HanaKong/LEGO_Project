...
<script>
	...
	function regProductChk() {
		...
		else if(discountRate == "" || discountRate >= 100) {
			alert("할인율을 입력해주세요.");
			return false;
		}
		else if(age == "") {
		    ...
		    <form name="myform" method="post" enctype="multipart/form-data">
		        <div class="category-box">
		            ...
		            <div class="item-input-box">
		                ...
		                <div class="value-input-box">
		                    <input type="number" name="productCode" placeholder="상품 코드를 입력해주세요." required />
		                </div>
		            </div>
		            <div class="item-input-box">
		                <div class="item-input-text">상품명</div>
		                <div class="value-input-box">
		                    <input type="text" name="productName" placeholder="상품의 이름을 입력해주세요" required />
		                </div>
		            </div>
		            <div class="item-input-box">
		            ...
		            <div class="item-input-box">
		                ...
		                <div class="value-input-box">
		                    <input type="number" name="discountRate" placeholder="할인율을 입력해주세요." required/>
		                </div>
		            ...
		            <div class="item-input-box">
		                ...
		                <div class="value-input-box">
		                    <input type="text" name="age" placeholder="나이제한을 입력해주세요" required/>
		                </div>
		                <span>※ 예시&#41; 8+ </span>
		            </div>
		            <div class="item-input-box">
		                ...
		                <div class="value-input-box">
		                    <input type="number" name="partsNumber" placeholder="부품수를 입력해주세요" required/>
		                </div>
		            </div>
		            <div class="item-input-box">
		                <div class="item-input-text">VIP 포인트</div>
		                <div class="value-input-box">
		                    <input type="number" name="point" placeholder="적립될 포인트를 입력해주세요" required/>
		                </div>
		            </div>
		            <div class="item-input-box">
		            ...
		            <div class="item-input-box">
		                ...
		                <div class="value-input-box radio-btn-align">
		                    <input type="radio" name="switchItem" id="switchOn" value="1" checked>
		                    <label for="switchOn">ON</label>
		                    <input type="radio" name="switchItem" id="switchOff" value="0">
		            ...
		            <div class="item-input-box-box">
	                    ...
	                    <div class="value-input-box-box"><textarea rows="6" name="content" id="CKEDITOR" class="form-control" required></textarea></div>
	                </div>
	                <script>
